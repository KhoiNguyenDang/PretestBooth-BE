...
import { CheckinVerifySchema, type CheckinVerifyDto } from './dto/checkin-verify.dto';
import {
...
export class CheckinController {
  ...
  updateThreshold(
    ...
    return this.checkinService.updateCheckinThreshold(
      req.user['role'],
      req.user['sub'],
      dto.threshold,
    );
  ...
  @Post('verify')
  verify(@Req() req, @Body(new ZodValidationPipe(CheckinVerifySchema)) dto: CheckinVerifyDto) {
